###############################################################
# ============================================================#
# OpenAI API Batch Processing Script                          #
...
api_key <- readline(prompt = "Enter your OpenAI API key: ")
...
call_openai <- function(text, api_key, model, temperature, prompt) {
